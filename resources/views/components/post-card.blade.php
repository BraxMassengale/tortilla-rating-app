<div {{ $attributes->merge(['class' => 'bg-white px-4 py-6 shadow sm:rounded-lg sm:p-6']) }}>
    <article aria-labelledby="question-title-81614">
        <div>
            <div class="flex space-x-3">
                ...
                <div class="min-w-0 flex-1 ml-2">
                    <p class="text-sm font-medium text-gray-900">
                        <a href="#" class="hover:underline">Patrícia Gomes</a>
                    </p>
            ...
            <h2 id="question-title-81614" class="mt-4 text-base font-medium text-gray-900">Classic con cebolla near Alhóndiga</h2>
        </div>
        <div class="mt-2 space-y-4 text-sm text-gray-700">
            <p>Had a nice tortilla at the bar behind alhóndiga.</p>
        </div>
        <div class="mt-6 flex justify-between space-x-8">
            <div class="flex space-x-6">
                    <span class="inline-flex items-center text-sm mr-2">
                      <button type="button" class="inline-flex space-x-2 text-gray-400 hover:text-gray-500">
                        ...
                        <span class="sr-only ml-1">likes</span>
                      </button>
                    </span>
                <span class="inline-flex items-center text-sm mr-2">
                      <button type="button" class="inline-flex space-x-2 text-gray-400 hover:text-gray-500">
                        ...
                        <span class="sr-only ml-1">replies</span>
                      </button>
                    </span>
                <span class="inline-flex items-center text-sm mr-2">
                      <button type="button" class="inline-flex space-x-2 text-gray-400 hover:text-gray-500">
                        ...
                        <span class="sr-only ml-1">views</span>
                      </button>
                    </span>
            </div>
