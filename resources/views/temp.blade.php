                ...
                <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                  <path fill-rule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clip-rule="evenodd" />
                    ...
                    <div class="mt-6 sm:max-w-xl">
                        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">The tortilla-centric social media app the world needs</h1>
                        <p class="mt-6 text-xl text-gray-500">You want tortilla and you
                            want it now. We get it. But before you rush to the nearest cafe to sink your teeth
                            into that potato-y egg-y goodness, make an account on this app. Why? Because you can
                            keep track of which tortillas you liked most! You can follow your friends to see
                            which tortillas they prefer! You can.. well that's about it.</p>
                    </div>
                    @if (Route::has('login'))
